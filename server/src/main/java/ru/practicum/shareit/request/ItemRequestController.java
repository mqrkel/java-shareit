...
public class ItemRequestController {
     ...
     */
    @PostMapping
    public ItemRequestResponseDto createRequest(@Positive @RequestHeader(USER_ID_HEADER) Long userId,
     ...
     */
    @GetMapping
    public List<ItemRequestResponseDto> getOwnRequests(@Positive @RequestHeader(USER_ID_HEADER) Long userId) {
    ...
    public ItemRequestResponseDto getRequestById(@Positive @RequestHeader(USER_ID_HEADER) Long userId,
