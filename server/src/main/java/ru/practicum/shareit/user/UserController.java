...
public class UserController {
    ...
    public UserResponseDto create(@Valid @RequestBody NewUserRequestDto newUserRequestDto) {
     ...
     */
    @PatchMapping("/{id}")
    public UserResponseDto update(@Positive  @PathVariable Long id, @Valid @RequestBody UserUpdateRequestDto userUpdateRequestDto) {
