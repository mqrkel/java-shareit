...
public class BookingController {
     ...
     */
    @GetMapping
    public List<BookingResponseDto> getBookingsByBooker(@Positive @RequestHeader(USER_ID_HEADER) Long userId,
     ...
     */
    @GetMapping("/owner")
    public List<BookingResponseDto> getBookingsByOwner(@Positive @RequestHeader(USER_ID_HEADER) Long ownerId,
                                                       @RequestParam(name = "state", defaultValue = "ALL") String state,
                                                       @RequestParam(defaultValue = "0") int from,
                                                       @RequestParam(defaultValue = "10") int size) {
