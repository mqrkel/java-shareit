...
public class ItemController {
     ...
     */
    @PostMapping
    public ItemResponseDto create(@RequestBody @Valid final ItemRequestDto itemRequestDto,
                                  @Positive @RequestHeader(USER_ID_HEADER) Long ownerId) {
    ...
    public ItemResponseDto update(@Positive @PathVariable Long itemId,
                                  @Valid @RequestBody ItemRequestUpdateDto updateDto,
                                  @Positive @RequestHeader(USER_ID_HEADER) Long ownerId) {
     ...
     */
    @GetMapping
    public List<ItemResponseDto> getItemsByOwner(@Positive @RequestHeader(USER_ID_HEADER) Long ownerId) {
